...
print WRITE "}\n";
print WRITE "\n";
print WRITE "__global__ void gpuKernel ( KernelArray<interval_gpu<float>> gpuMainQue, KernelArray<float> gpuPriQue, int dimension )\n";
print WRITE "{\n";
print WRITE "   //printf(\"Testing ................\\n\");\n";
print WRITE "   __shared__ interval_gpu<float> SharedIntervalList[DIM] ; // Warning thrown due to blank constructor\n";
print WRITE "   __shared__ float RandSampleList[DIM] ;\n";
print WRITE "   __shared__ float SharedIntDimSample[DIM][K];\n";
...
print WRITE "void gpuHandlerThread ( KernelArray<interval_gpu<float>> gpuMainQue, KernelArray<float> gpuPriQue, int dimension) {\n";
...
print WRITE "   thrust::device_vector<interval_gpu<float>> gpu_interval_list ;\n";
print WRITE "   thrust::device_vector<float>               gpu_interval_priority ;\n";
print WRITE "   thrust::device_vector<float>               fbestTag ;\n";
print WRITE "   KernelArray<interval_gpu<float>>           gpuMainQue ;\n";
print WRITE "   KernelArray<float>                         gpuPriQue  ;             \n";
print WRITE "\n";
...
print WRITE "			       interval_gpu<float> ij_gpu = gpu_interval_list[i*dimension + j] ;\n";
...
print WRITE "			       for(int j=0; j<dimension; j++) {\n";
print WRITE "			          interval_gpu<float> ij(MainQue[i*dimension+j].left(), MainQue[i*dimension+j].right()) ;\n";
