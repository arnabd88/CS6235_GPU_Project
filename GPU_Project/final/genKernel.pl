...
open(WRITE,">workListKernel_$filename.cu");
...
print WRITE "#define intervalEpsilon 0.01\n"; 
print WRITE "#define outputEpsilon 0.01\n"; 
print WRITE "#define K 10 // Sampling number\n";
print WRITE "#define DIM $varCount // Dimension\n";
print WRITE "#define GPU_CALL_INTERVAL 0.00001\n";
print WRITE "#define cpu_gpu_tolerance 0.1\n";
print WRITE "\n";
#print WRITE "#define NEW_INTV_THRESHOLD $NEW_INTV_THRESHOLD\n";
print WRITE "#define NEW_INTV_THRESHOLD 12\n";
#print WRITE "#define CPU_THRESHOLD $CPU_THRESHOLD\n";
print WRITE "#define CPU_THRESHOLD 8\n";
print WRITE "#define USE_GPU 0\n";
print WRITE "\n";
...
print WRITE "\n";
#print WRITE "\n//-----------------------------------------------\n";
print WRITE "__device__ double gpu_func_array_expr ( double* var ) {\n";
print WRITE "   double func;\n";
...
print WRITE "   double localSampleList[DIM] ;\n";
...
print WRITE "		   dim3 dimGrid(gpuPriQue._size/dimension);\n";
print WRITE "\n";
...
print WRITE "   double gpuCallIntervalTimer, gpuStartTimer;\n";
print WRITE "   int stopGpu = 0;\n";
...
print WRITE "   deque<gaol::interval> gpubestbbInt ;\n";
...
print WRITE "   fbestTag = numeric_limits<float>::min() ;\n";
print WRITE "\n";
...
print WRITE "\n";
print WRITE "   #pragma omp parallel for\n";
...
print WRITE "   double startComputeTime = omp_get_wtime() ;\n";
...
print WRITE "              gpubestbbInt.clear();\n";                    
...
print WRITE "                             if(i==(int)gpu_interval_list.size()/dimension-1)\n";
print WRITE "                                  gpubestbbInt.push_front(ij) ;\n";
print WRITE "			   }\n";
print WRITE "			   //MainQue_priority.push_front(gpu_interval_priority[i]) ;\n";
print WRITE "		   }\n";
#print WRITE "              	  gpu_interval_priority.clear();\n";
print WRITE "            	  fbestTag = gpu_interval_priority[((int)gpu_interval_list.size()/dimension-1)*dimension - 1];\n";
print WRITE "            	  if(fbestTag - fbest > 0 && fbestTag - fbest < cpu_gpu_tolerance ||\n";
print WRITE "            	     fbest - fbestTag > 0 && fbest - fbestTag < cpu_gpu_tolerance) stopGpu = 1 ;\n";
print WRITE "            	  else  stopGpu = 0;\n";
print WRITE "            		 //  cout << \"From GPU fbestTag = \" << fbestTag << endl ;\n";
print WRITE "                  gpu_interval_priority.clear();\n";
print WRITE "            		  gpu_interval_list.clear();\n";
print WRITE "            	  gpuStartTimer = omp_get_wtime() ;\n";
print WRITE "	  }\n";
...
print WRITE "	  }\n";
print WRITE "          if(ManageThreads.size()==0) gpuCallIntervalTimer = omp_get_wtime() - gpuStartTimer;\n";
print WRITE "	  if(USE_GPU==1 && (int)MainQue_priority.size()/dimension - CPU_THRESHOLD > NEW_INTV_THRESHOLD && ManageThreads.size()==0 && gpuCallIntervalTimer>GPU_CALL_INTERVAL && stopGpu==0) {   // minimum number of new intervals to trigger gpu\n";
print WRITE "			  //gpu_interval_list.clear();\n";
print WRITE "			  //gpu_interval_priority.clear();\n";
print WRITE "                    //cout << \"MainQueSize = \" << (int)MainQue.size() <<  endl ;\n";
print WRITE "			gpuStartTimer = 0 ;\n";
print WRITE "			gpuCallIntervalTimer = 0 ;\n";
...
print WRITE "	   }\n";
print WRITE "       \n";
print WRITE "	   fbest = returnMax(fbest, fbestTag);\n";
...
print WRITE "	   }\n";
print WRITE "  }\n";
print WRITE "            cout << \"Total Compute Time = \" << omp_get_wtime() - startComputeTime << endl ;\n";
print WRITE "			printf(\"fbest = %f \\n\", fbest);\n";
print WRITE "			cout << \"Current Best Interval = \" ;\n";
print WRITE "			for(int k=0; k<dimension; k++) cout << \" \" << bestbbInt[k] ; cout <<endl ;\n";
print WRITE "			cout << \"last Best from GPU = \" ;\n";
print WRITE "			for(int k=0; k<dimension; k++) cout << \" \" << gpubestbbInt[k] ;\n";
print WRITE "			cout << endl ;\n";
...
system("/usr/local/cuda-7.5/bin/nvcc -I/usr/local/cuda-7.5/include/ -I/usr/local/cuda-7.5/samples/common/inc/ -I/usr/local/cuda-7.5/samples/6_Advanced/interval/ -g -Xcompiler -fopenmp --std=c++11 workListKernel_$filename.cu -I../../Gaol/gaol-4.2.0/gaol/.libs/ -L../../Gaol/gaol-4.2.0/gdtoa/.libs/ -I. -lgaol -lm -lultim -lgdtoa -lgomp");
